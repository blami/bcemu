...
/* cpu_op_util.h: HuC6280 CPU opcode generator helper macros */
...
#ifndef __PCE_CPU_OP_UTIL_H
#define __PCE_CPU_OP_UTIL_H
...
#define WRMEM(addr,data)                                                \
	pce_cpu_mem_w((pce_cpu->mmr[(addr) >> 13] << 13) |                  \
		((addr) & 0x1fff), data);
